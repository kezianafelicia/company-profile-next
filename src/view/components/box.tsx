...
export default function Box(props: IBox) {
  return (
    <div className=" bgw-full shadow-xl flex flex-col p-4 my-4 rounded-md hover:scale-105 duration-300 bg-[#fbf1ef] text-[#3B3030] border-2 border-[#faecea] mx-5">
    ...
    <div>
    <h2 className=" items-center text-lg text-center pt-5 font-lg text-[#493628] ">{props.heading}</h2>
    </div>
